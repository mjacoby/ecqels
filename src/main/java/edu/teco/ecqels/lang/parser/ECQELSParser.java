...
public class ECQELSParser extends ECQELSParserBase implements ECQELSParserConstants {

    boolean allowAggregatesInExpressions = true;
...
// ---- Definitions of each pattern element
    ...
    final public Element GraphGraphPattern() throws ParseException {
        ...
        jj_consume_token(GRAPH);
        n = VarOrIRIref();
        refreshDuration = RefreshPattern();
        el = GroupGraphPattern();
        {
            if ("" != null) {
                return (refreshDuration == null) ? new ElementNamedGraph(n, el) : new ElementRefreshableNamedGraph(n, el, refreshDuration);
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public Element StreamGraphPattern() throws ParseException {
        ...
        {
            if ("" != null) {
                return (refreshDuration == null) ? new ElementStream(n, w, el) : new ElementRefreshableStream(n, w, el, refreshDuration);
            }
        }
        throw new Error("Missing return statement in function");
    }

    final public Duration RefreshPattern() throws ParseException {
    ...
    final public WindowInfo WindowPattern() throws ParseException {
        WindowInfo window;
        jj_consume_token(LBRACKET);
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case NOW: {
                jj_consume_token(NOW);
                window = new WindowInfo(WindowInfo.WindowType.NOW);
                break;
            }
            case ALL: {
                jj_consume_token(ALL);
                window = new WindowInfo(WindowInfo.WindowType.ALL);
                break;
            }
            case RANGE: {
    ...
    final public WindowInfo RangeWindowPattern() throws ParseException {
        Duration duration;
        ...
        {
            if ("" != null) {
                return new WindowInfo(duration, slideDuration, tumbling);
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public Duration DurationPattern() throws ParseException {
        ...
        {
            if ("" != null) {
                return getDuration(t.image);
            }
        }
        throw new Error("Missing return statement in function");
    }

    final public WindowInfo TripleWindowPattern() throws ParseException {
        Token t;
        jj_consume_token(TRIPLES);
        t = jj_consume_token(INTEGER);
        {
            if ("" != null) {
                return new WindowInfo(integerValue(t.image));
            }
        }
        throw new Error("Missing return statement in function");
    }
    ...
    final public Element ServiceGraphPattern() throws ParseException {
        ...
        {
            if ("" != null) {
                return (refreshDuration == null) ? new ElementService(n, el, silent) : new ElementRefreshableService(n, el, silent, refreshDuration);
            }
        }
        throw new Error("Missing return statement in function");
    }
...
// The case of "?var()" or just "?var"
     ...
     */
    public ECQELSParserTokenManager token_source;
    ...
    private static void jj_la1_init_1() {
        jj_la1_1 = new int[]{0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0x600000, 0x800000, 0xf0600000, 0xf0600000, 0xf0600000, 0x10, 0x10, 0x0, 0x30, 0x0, 0x0, 0x10, 0x20, 0x10, 0x8, 0x20, 0x1000000, 0x2000000, 0x0, 0x0, 0x600000, 0x800000, 0x600000, 0x600000, 0x600006, 0x6, 0x600000, 0x600006, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x10, 0x8, 0x80, 0x80, 0x88, 0x88, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7f4180, 0x0, 0x0, 0x0, 0x0, 0x7f4180, 0xc00, 0x3000, 0x3000, 0x0, 0x8000, 0x600000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400000, 0x400000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0600000, 0xf0600000, 0x0, 0x600000, 0x0, 0x0, 0x0, 0xf0600000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf0000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,};
    }

    private static void jj_la1_init_2() {
        jj_la1_2 = new int[]{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffffef60, 0x0, 0xffffef6d, 0xffffef6d, 0xffffef6d, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffffef60, 0x0, 0xffffef60, 0xffffef60, 0xffffef60, 0x0, 0xffffef60, 0xffffef60, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffffef60, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffffef6d, 0xffffef6d, 0x0, 0xffffef60, 0x0, 0x0, 0x0, 0xffffef6d, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xd, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,};
    }

    private static void jj_la1_init_3() {
        jj_la1_3 = new int[]{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7fbffff, 0x0, 0x7fbffff, 0x7fbffff, 0x7fbffff, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1fbffff, 0x0, 0x1fbffff, 0x1fbffff, 0x1fbffff, 0x0, 0x1fbffff, 0x1fbffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x6000000, 0x0, 0xf0000000, 0x0, 0xf0000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x30000000, 0x0, 0x0, 0x20000000, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x6000000, 0x6000000, 0x6000000, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x6000000, 0x6000000, 0x0, 0x0, 0x20000, 0x0, 0x0, 0x0, 0x0, 0x1fbffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x6000000, 0x6000000, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7fbffff, 0x7fbffff, 0x0, 0x1fbffff, 0x0, 0x0, 0x0, 0x7fbffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0,};
    }

    private static void jj_la1_init_4() {
        jj_la1_4 = new int[]{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff40000, 0x0, 0xff40000, 0xff40000, 0xff40000, 0x0, 0x0, 0xff40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff40000, 0x0, 0x0, 0xff40000, 0x100, 0x84ff, 0x0, 0x84ff, 0x100, 0x200, 0x0, 0x800, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x8000, 0x0, 0x0, 0x10000, 0x0, 0x0, 0x0, 0x800, 0x800, 0x0, 0x0, 0x0, 0x0, 0x2000, 0x6000, 0x6000, 0xff40000, 0x0, 0x0, 0xff40000, 0xff40000, 0xff40000, 0x0, 0x0, 0xff40000, 0x0, 0x0, 0xff40000, 0xff40000, 0x0, 0x0, 0x4000, 0x0, 0x0, 0x200, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff40000, 0x0, 0xff40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40000, 0x0, 0x40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff40000, 0xff40000, 0xff40000, 0x0, 0x0, 0xff40000, 0x0, 0x0, 0x0, 0x0, 0xfc00000, 0xfc00000, 0x0, 0x0, 0xfc00000, 0x0, 0x0, 0xff40000, 0xff40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff40000, 0x340000, 0x1c00000, 0xe000000, 0x0, 0x0, 0x0, 0x0, 0x0,};
    }

    private static void jj_la1_init_5() {
        jj_la1_5 = new int[]{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf, 0x0, 0x1f, 0x1f, 0x1000001f, 0x0, 0x0, 0xa5f, 0x80, 0x0, 0x10000000, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x10, 0x10, 0x10, 0x0, 0x10, 0x10, 0x0, 0x0, 0x0, 0x0, 0x50, 0xf, 0x50, 0x0, 0xf, 0x0, 0x0, 0x1000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa5f, 0x0, 0x4000, 0xa5f, 0xa5f, 0xa5f, 0x4000, 0x0, 0xa5f, 0x80, 0x4000, 0xa5f, 0xa5f, 0x4000, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10, 0x0, 0x2000, 0x50, 0x2000, 0x50, 0xa5f, 0x4000, 0xa5f, 0x1000, 0x0, 0x0, 0x2000, 0x0, 0xa5f, 0x200010, 0x1000, 0x200010, 0x200010, 0x0, 0x0, 0x20000000, 0x20000000, 0x14000080, 0x200010, 0x100, 0x2100, 0x2000, 0x14000080, 0x200010, 0x0, 0x0, 0x10, 0x0, 0x0, 0x210, 0xa5f, 0xa5f, 0x84f, 0x0, 0x0, 0x84f, 0x1000000, 0x2000000, 0x1f8000, 0x1f8000, 0xc000000, 0x0, 0x30000000, 0x30000000, 0xc000000, 0x30000000, 0x30000000, 0xc20001f, 0x1f, 0x50, 0x0, 0x2000, 0x2000, 0x0, 0x1c20001f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1000, 0x0, 0x50, 0x50, 0x40000000, 0x40000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf, 0x0, 0x0, 0x800,};
    }

    private static void jj_la1_init_6() {
        jj_la1_6 = new int[]{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x0, 0x4, 0x4, 0x0, 0x2, 0x4, 0x4, 0x20, 0x4, 0x0, 0x0, 0x0, 0x20, 0x0, 0x2, 0x4, 0x4, 0x0, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,};
    }
     ...
     */
    public ECQELSParser(java.io.InputStream stream) {
        this(stream, null);
    }
     ...
     */
    public ECQELSParser(java.io.InputStream stream, String encoding) {
        try {
            jj_input_stream = new JavaCharStream(stream, encoding, 1, 1);
        } catch (java.io.UnsupportedEncodingException e) {
            throw new RuntimeException(e);
        }
        token_source = new ECQELSParserTokenManager(jj_input_stream);
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
        for (int i = 0; i < 175; i++) {
     ...
     * Constructor.
     */
    public ECQELSParser(java.io.Reader stream) {
     ...
     */
    public ECQELSParser(ECQELSParserTokenManager tm) {
        token_source = tm;
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
     ...
     * Reinitialise.
     */
    public void ReInit(ECQELSParserTokenManager tm) {
        token_source = tm;
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
